...
import { useDanmaku, useDanmakuPool } from './hooks';
...
describe('弹幕 React Hooks 模块', () => {
  ...
  describe('useDanmaku Hook', () => {
    ...
    it('应该能批量添加弹幕', () => {
      ...
      act(() => {
        result.current.addDanmakuBatch([mockDanmakuMessage, mockDanmakuMessage2, mockDanmakuMessage3]);
      });
  ...
  describe('useDanmakuPool Hook', () => {
    ...
    it('应该能批量添加弹幕到弹幕池', () => {
      ...
      act(() => {
        result.current.addToPoolBatch([mockDanmakuMessage, mockDanmakuMessage2, mockDanmakuMessage3]);
      });
