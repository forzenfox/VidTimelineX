      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            {/* 洞主信息 */}
            <div
              className={`flex items-center gap-3 px-4 py-2 rounded-xl theme-transition border-2 border-[#AED6F1] ${theme === "dongzhu" ? "ring-2 ring-offset-2 ring-[#5DADE2]" : "opacity-60"}`}
              style={{
                background:
            ...
            {/* 凯哥信息 */}
            <div
              className={`flex items-center gap-3 px-4 py-2 rounded-xl theme-transition border-2 border-[#E74C3C] ${theme === "kaige" ? "ring-2 ring-offset-2 ring-[#E74C3C]" : "opacity-60"}`}
              style={{
