...
const VideoCard: React.FC<VideoCardProps> = ({ video, onClick }) => {
  ...
  return (
    <div 
      ...
      className="group relative bg-card rounded-xl overflow-hidden border border-border cursor-pointer shadow-custom transition-transform hover:-translate-y-1"
    >
      {/* Thumbnail */}
      <div className="relative aspect-video overflow-hidden">
        ...
        {/* Category Tag */}
        <div className="absolute top-2 left-2 px-2 py-1 bg-primary/90 text-primary-foreground text-xs font-bold rounded-md flex items-center shadow-md">
