...
每个功能模块的代码组织在独立的文件中，如视频爬取功能在 auto_crawler.py 文件中，元数据处理功能在 crawl_metadata.py 文件中。数据文件放在 data 目录下，模板文件放在 templates 目录下。这种结构使得代码易于定位和维护。
